...
## CUDA Programming Resources from Nvidia
### Blog Posts
...
- [CUDA Pro Tip: The Fast Way to Query Device Properties](https://developer.nvidia.com/blog/cuda-pro-tip-the-fast-way-to-query-device-properties/)
